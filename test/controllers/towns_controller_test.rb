...
class TownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post towns_url, params: { town: { county: @town.county, market_id: @town.market_id, name: @town.name, state: @town.state } }
    end
  ...
  test "should update town" do
    patch town_url(@town), params: { town: { county: @town.county, market_id: @town.market_id, name: @town.name, state: @town.state } }
